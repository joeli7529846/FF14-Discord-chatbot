...
class ask(Cog_Extension):
    ...
    def read_gsheet(self):
        ...
        df =  ws.get_as_df(has_header=True,empty_value='', include_tailing_empty=False,include_tailing_empty_rows=True,numerize=False)
        #df 存成字典格式
        ...
        info_df =  ws.get_as_df(has_header=True,empty_value='', include_tailing_empty=False,include_tailing_empty_rows=True,numerize=False)
